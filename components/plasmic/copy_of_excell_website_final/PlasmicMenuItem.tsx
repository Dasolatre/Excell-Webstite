...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: mw-GwsxOQA-R/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___63FjJ)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__cgZn)}>
            <div
              className={classNames(
                projectcss.all,
