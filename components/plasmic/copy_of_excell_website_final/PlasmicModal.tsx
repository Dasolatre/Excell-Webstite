...
import sty from "./PlasmicModal.module.css"; // plasmic-import: lgsomw0eD6RV/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_1S_-Wa7L1xvb"]]: true })}
        ...
        >
          ...
          >
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__mmohV)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__tB5G)}>
                  <Button
                    color={"muted"}
                    label={
                      <div
