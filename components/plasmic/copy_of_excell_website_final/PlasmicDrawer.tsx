...
import Button from "../../Button"; // plasmic-import: MGep8UwM7_bk/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: jEzkFwVwVWJc/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_RIs1oyTTL6s6"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox___76Sbz)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              <div className={classNames(projectcss.all, sty.freeBox__jpt6X)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__ttWH)}
                    >
                      <Button
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__mj6Eu)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
