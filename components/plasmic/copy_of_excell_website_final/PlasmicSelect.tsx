...
import Label from "../../Label"; // plasmic-import: zHvsX2YNJ4Sq/component
...
import Description from "../../Description"; // plasmic-import: ZZ_VKzTtSB3X/component
import MenuPopover from "../../MenuPopover"; // plasmic-import: 8zHKcuG63XSS/component
import MenuItem from "../../MenuItem"; // plasmic-import: mw-GwsxOQA-R/component
import MenuSection from "../../MenuSection"; // plasmic-import: Ty9ivWtT2Pyp/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: Q4ZrgsZACbBO/css
...
export type PlasmicSelect__OverridesType = {
  ...
  region?: Flex__<typeof BaseButton>;
  ...
  return (
    ...
    >
      ...
      <BaseButton
        ...
        className={classNames("__wab_instance", sty.region, {
          [sty.regiontype_soft]: hasVariant($state, "type", "soft")
        })}
      >
        <BaseSelectValue
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__jNg6Y)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
...
const PlasmicDescendants = {
  ...
  label: ["label"],
  region: ["region", "ariaSelectedValue", "text", "svg"],
